                    ...
                    <div class="navbar">
                      ...
                      <div class="nav-collapse collapse">
                    	<ul class="nav nav-pills ddmenu">
						    ...
						    <li><a href="./viewexcel">ExcelSheet</a></li> 
                        </ul>
                      </div>
                    </div>
                  </div>
...
<hr>
    <div class="contentArea">
                ...
                <div class="span3">     
                    <div class="sidebox">
                        <h3 class="sidebox-title"><b>Add Product</b></h3>
                          <ul>
                          <form role="form" action="./product/add" method="post" id="myForm" class="login" commandName="product" >
                          	<label>Product Name</label>
							<input type="text" name="productName"  style="text-transform: capitalize;"  placeholder="Product Name" autofocus required/>
								<span class="input-group-addon"></span>
									...
									<input type="text" name="imageName"  style="text-transform: capitalize;"  placeholder="Product Image" autofocus required/>
									
									<label>Product Price (Rs.)</label> 
									<input type="text" name="productPrice"  style="text-transform: capitalize;"  placeholder="Product Price" autofocus required/>
									
									<label>Product Count</label> 
									<input type="text" name="productQuantity"  style="text-transform: capitalize;"  placeholder="Product Count" autofocus required/>
   									<button>
